...
public class technical extends student{
	...
	{
		student s=null;
		FileInputStream is = new FileInputStream("C:\\Users\\Dell\\Desktop\\project\\g_technical_vote.txt");	// candidates who have given their vote in general technical elections.	
		...
		try 
		{	
			FileOutputStream fos = new FileOutputStream(new File("C:\\Users\\Dell\\Desktop\\project\\g_technical_vote.txt"),true);
...
//			sc.close();
	...
	public static void vote() throws IOException, ClassNotFoundException
	{
		...
		FileInputStream is1 = new FileInputStream("C:\\Users\\Dell\\Desktop\\project\\t_selected.txt");	
		if(is1.available()==0)
		{
...
//					s[j].c_comittee+=1;			// c_comittee is for counting votes for selected candidates
			...
			try 
			{	
				BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\Dell\\Desktop\\project\\stats_gen_technical.txt", true)  //Set true for append mode
                    );  
   //Add new line
